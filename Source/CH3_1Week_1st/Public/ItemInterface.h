 ...
 * 
 */
class CH3_1WEEK_1ST_API IItemInterface
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION()
	virtual void OnItemEndOverlap(UPrimitiveComponent* OverlapComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex) = 0;
